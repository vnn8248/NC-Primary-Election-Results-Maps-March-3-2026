...
def build_local_district_map(
    ...
    """
    Build a precinct-level GeoJSON for a local district contest.

    Keeps all precinct polygons in the specified county.
    Precincts that appear in the contest results are marked
    as participating; other precincts in the county remain
    available for gray/background treatment.
    """
